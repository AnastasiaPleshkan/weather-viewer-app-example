...
public class ApiResponseTest {
    ...
    public void exception() {
        Exception exception = new Exception("moscow");
        ...
        assertThat(apiResponse.errorMessage, is("moscow"));
    }

    @Test
    public void success() {
        ApiResponse<String> apiResponse = new ApiResponse<>(Response.success("moscow"));
        assertThat(apiResponse.errorMessage, nullValue());
        assertThat(apiResponse.code, is(200));
        assertThat(apiResponse.body, is("moscow"));
